...
class ProductRepository:
    ...
    async def upsert_product_with_offers(self, product_in: ProductIn, offers_in: List[OfferIn]) -> Product:
        ...
        await self.db.execute(delete(Offer).where(Offer.product_id == existing.id))
        for o in offers_in:
